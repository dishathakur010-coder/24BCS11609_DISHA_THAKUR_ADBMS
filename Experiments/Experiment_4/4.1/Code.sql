https://www.codechef.com/viewsolution/1321347663
...
SELECT c.customer_name, o.order_id, c.customer_id, o.product_name, o.order_date, o.quantity FROM customers AS c INNER JOIN orders AS o ON c.customer_id=o.customer_id;
SELECT p.product_name,c.category_name FROM products AS p INNER JOIN categories c ON p.category_id=c.category_id;
SELECT c.category_name,p.product_name,p.price FROM products AS p INNER JOIN categories AS c ON p.category_id=c.category_id;
